...
| intfloat/multilingual-e5-large-instruct                          | Instruct: retrieve semantically similar text.<br>Query:                           | Instruct: Determine whether the two given sentences express the same meaning or not.<br>Query: | Instruct: Identify the topic or theme of the given texts<br>Query:                             | nan                  |
