...
| facebook/drama-1b-fp16                                           |         80.76 |         61.09 |                51.1  |               70.92 |              56.43 |     12 |
| upskyy/bge-m3-korean                                             |         84.67 |         70.82 |                42.74 |               67.91 |              54.16 |     13 |
...
| dragonkue/snowflake-arctic-embed-l-v2.0-ko                       |      63.27 |     65.04 |                      52.32 |         60.21 |     12 |
| Snowflake/snowflake-arctic-embed-l-v2.0                          |      59.86 |     63.78 |                      53.2  |         58.95 |     13 |
...
| facebook/drama-1b-fp16                                           |     36.06 |                                71.07 |                            46.18 |                51.1  |     12 |
| upskyy/bge-m3-korean                                             |     22.08 |                                73.49 |                            32.66 |                42.74 |     13 |
...
| kakaocorp/kanana-nano-2.1b-embedding-fp16                        | (큰 차이는 없었음)None or Instruct: retrieve semantically similar text.nQuery: |                                                                                             | Instruct: Identify the topic or theme of the given textsnQuery:                             | 허깅페이스 기준 적용 |
| Alibaba-NLP/gte-Qwen2-7B-instruct-fp16                           | Instruct: retrieve semantically similar text.nQuery:                           | Instruct: retrieve semantically similar text.nQuery:                                        | Instruct: Given a web search query, retrieve relevant passages that answer the querynQuery: | 허깅페이스 기준 적용 |
| BAAI/bge-multilingual-gemma2-fp16                                | <instruct>retrieve semantically similar text.n<query>                          | <instruct>retrieve semantically similar text.n<query>                                       | <instruct>Identify the topic or theme of the given textsn<query>                            | 허깅페이스 기준 적용 |
| intfloat/multilingual-e5-large-instruct                          | Instruct: retrieve semantically similar text.nQuery:                           | Instruct: Determine whether the two given sentences express the same meaning or not.nQuery: | Instruct: Identify the topic or theme of the given textsnQuery:                             | 허깅페이스 기준 적용 |
